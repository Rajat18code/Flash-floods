...
| :--- | :--- | :--- | :--- | :--- | :---: | :--- |
| **Historical Weather Baseline** | `data/raw/himachal_weather.csv` | **NASA POWER Project (MERRA-2 Reanalysis)**<br>NASA Langley Research Center<br>Reference: `https://power.larc.nasa.gov` | 31.10°N, 77.17°E<br>Shimla / Sutlej River Basin<br>Grid Elevation: 897.65 m (Area-averaged 0.5° × 0.625° cell) | **2015-01-01 to 2024-12-31**<br>*(3,653 days verified observational baseline)* | **Verified Third-Party Reanalysis** | • `PRECTOTCORR`: Precipitation Corrected (mm/day)<br>• `T2M`: Temperature at 2 m (°C)<br>• `RH2M`: Relative Humidity at 2 m (%)<br>• `WS2M`: Wind Speed at 2 m (m/s) |
